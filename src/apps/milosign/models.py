...
class Document(db.Model):
    ...
    # Relaciones
    signatures = db.relationship('Signature', backref='document', 
    ...
    def get_signature_progress(self):
        ...
        return {'signed': signed, 'total': total, 'percentage': (signed/total)*100 if total > 0 else 0}
...
class Signature(db.Model):
    ...
    signature_type = db.Column(db.String(20), default='digital')  # digital, biometric, etc.
